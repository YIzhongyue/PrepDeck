...
export const ChartLegendContent = ({ reversed, payload, align, layout, className }: LegendContentProps & { reversed?: boolean; className?: string }) => {
    // Local change (docs/guides/ui-components.md): `toReversed` is ES2023 and
    // this workspace targets a lower lib, so the same copy-then-reverse is
    // spelled out. `payload` is readonly, hence the slice rather than reverse().
