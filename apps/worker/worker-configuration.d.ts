/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 96eab60950912258ed4f8b660641df74)
...
interface __BaseEnv_Env {
	...
	AUTH_MODE: "cookie";
	APP_BASE_URL: "http://localhost:5173" | "https://prepdeck.example.com";
	EMAIL_FROM_ADDRESS: "noreply@example.com" | "noreply@example.com";
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimiterObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RateLimiterObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ENABLE_DEV_PASSWORD_LOGIN" | "CIRCUIT_MODE" | "EMERGENCY_ADMIN_IPS" | "MCP_USER_RATE_LIMIT_PER_MINUTE" | "MCP_ADMIN_RATE_LIMIT_PER_MINUTE" | "MCP_KP_WRITE_RATE_LIMIT_PER_MINUTE" | "MCP_ADMIN_MUTATION_RATE_LIMIT_PER_MINUTE" | "MCP_METRICS_ENABLED" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "GOOGLE_CLIENT_ID" | "AUTH_MODE" | "APP_BASE_URL" | "EMAIL_FROM_ADDRESS">> {}
}
